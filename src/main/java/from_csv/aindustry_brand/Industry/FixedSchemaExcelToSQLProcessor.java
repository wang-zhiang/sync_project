...
public class FixedSchemaExcelToSQLProcessor {
    ...
    public static void main(String[] args) {
        ...
        String tableName = "ecommerce_insight_fixed_202601"; // 可以修改为用户指定的表名
        ...
        try {
            ...
            // 处理文件夹中的所有Excel文件
            String basePath = "D:\\wzza\\develop\\idea_project\\ceshi\\src\\main\\java\\from_csv\\aindustry_brand\\Industry\\全域洞察1-5(全部更新版)\\2026-1行业洞察"; // 根据实际情况调整路径
