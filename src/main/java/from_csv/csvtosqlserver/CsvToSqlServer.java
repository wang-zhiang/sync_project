...
public class CsvToSqlServer {
    ...
    // 配置变量 - 请根据需要修改
    private static final String TABLE_NAME = "ali_normal_20260204"; // 目标表名
    private static final String CSV_FILE_PATH = "D:\\wzza\\develop\\idea_project\\ceshi\\src\\main\\java\\from_csv\\csvtosqlserver\\data\\ali_normal.csv"; // CSV文件路径
