...
public class search {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection(url, username, password);
            ...
            for (String tableName : tableNames) {
                String sql = buildSqlQuery(tableName);
    ...
    private static String buildSqlQuery(String tableName) {
        // 替换为你的实际 SQL 查询
        String sql  = "SELECT \n" +
                ...
                "WHERE  t1.categoryid = t4.id AND t4.industryid = 59 AND t4.industryid = t2.id AND t4.spid = t3.id AND t4.industryid = t3.pid \n" +
