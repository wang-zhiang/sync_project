...
public class MongoToSqlSyncStringSafe {
    ...
    public MongoToSqlSyncStringSafe(String sqlServerUrl, String sqlServerUser, String sqlServerPassword,
        ...
        try (PreparedStatement pstmt = sqlConnection.prepareStatement(insertSQL)) {
            for (Document doc : batch) {
                for (int i = 0; i < columns.size(); i++) {
                    ...
                    pstmt.setString(i + 1, formatValue(value));
                }
                pstmt.addBatch();
            }
            pstmt.executeBatch();
    ...
    private String formatValue(Object value) {
        ...
        if (value instanceof Decimal128) {
            BigDecimal bd = ((Decimal128) value).bigDecimalValue();
