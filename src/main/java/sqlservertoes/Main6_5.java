...
public class Main6_5 {
    ...
    private List<SpCategorySql> loadSqlConfigs() throws SQLException {
        ...
        String sql = "SELECT Id, SpCategoryId, ChannelType, DbHost, DbPort, DbName, SqlContent FROM CL_Common_SpCategorySql where SpCategoryId in (63);";
