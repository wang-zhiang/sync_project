...
public class Main7_cs {
    ...
    private List<SpCategorySql> loadSqlConfigs() throws SQLException {
        ...
        String sql = "SELECT Id, SpCategoryId, ChannelType, DbHost, DbPort, DbName, SqlContent FROM CL_Common_SpCategorySql where SpCategoryId in  (1,104);";
